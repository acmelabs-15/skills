...
const parts: Part[] = [
  ...
  // granularity for these SPECs. Retro-validation context captured in Blockers + Observations.
  {
    ...
    dod: [
      { text: "All 6 TASKs from SPEC-002 implemented (ANALYSIS + SESSION adapters)", done: false, deferred_rationale: "code on main; awaiting retro-validation QA close" },
      { text: "Round-trip property tests pass for ANALYSIS + SESSION fixtures", done: false, deferred_rationale: "awaiting retro-validation QA close" },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "4 mandatory exit gates: code-qualities-assessment + incoherence + orphan-ref + lint", done: false, deferred_rationale: "awaiting retro-validation close" },
      { text: "SPEC-002 IN_PROGRESS → DONE", done: false, deferred_rationale: "awaiting retro-validation close" },
    ],
  },
  {
    id: "build.SPEC-003",
    ...
    dod: [
      { text: "All 5 TASKs from SPEC-003 implemented", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "Round-trip property test passes for PLAN fixtures", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "4 mandatory exit gates pass", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "SPEC-003 IN_PROGRESS → DONE", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
    ],
  },
  {
    id: "build.SPEC-004",
    ...
    dod: [
      { text: "All 7 TASKs from SPEC-004 implemented (recursive subtree rewrite + per-file hash validation)", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "Round-trip property test passes for SPEC subtree fixtures", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "4 mandatory exit gates pass", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "SPEC-004 IN_PROGRESS → DONE", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
    ],
  },
  {
    id: "build.SPEC-005",
    ...
    dod: [
      { text: "All 6 TASKs from SPEC-005 implemented", done: false },
      { text: "/decompose and /recompose skills operational against ADR notes (PROOF)", done: false },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false },
      { text: "4 mandatory exit gates pass", done: false },
      { text: "SPEC-005 IN_PROGRESS → DONE", done: false },
    ],
  },
  {
    id: "build.SPEC-006",
    ...
    dod: [
      { text: "All 7 TASKs from SPEC-006 implemented", done: false },
      { text: "/defrag operational as periodic curator", done: false },
      { text: "/ingest auto-detects Brain vs Basic Memory from frontmatter", done: false },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false },
      { text: "4 mandatory exit gates pass", done: false },
      { text: "SPEC-006 IN_PROGRESS → DONE", done: false },
    ],
  },
  {
    id: "build.SPEC-007",
    ...
    dod: [
      { text: "All 13 TASKs from SPEC-007 implemented", done: false, deferred_rationale: "Wave 2 retro-validation in progress; gap-TASK TASK-014 dogfood migration executing this turn" },
      { text: "Round-trip property test passes for PLAN-001 + SESSION fixtures (SHA-256)", done: false, deferred_rationale: "TASK-014 executing now" },
      { text: "PLAN-001 successfully re-authored in trimmed form using new tooling", done: false, deferred_rationale: "TASK-014 executing now" },
      { text: "/plan and /session skills updated to use new mutation API", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "Per-task QA gate PASS + spec-level coverage matrix PASS", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "4 mandatory exit gates pass", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
      { text: "SPEC-007 IN_PROGRESS → DONE", done: false, deferred_rationale: "Wave 2 retro-validation in progress" },
    ],
  },
  {
    ...
    dod: [
      { text: "All X.A through X.E sub-phases DONE", done: false, deferred_rationale: "X.E.2 + X.E.3 blocked on Wave 2 retro-validation close" },
      ...
      { text: "PLAN-001 frontmatter shows Phase X DONE", done: false, deferred_rationale: "depends on X.E.2 final reconciliation" },
      { text: "All pending user decisions (D1-D4 in ANALYSIS-003) resolved + applied", done: false, deferred_rationale: "D2 + D4 pending Wave 2 close" },
    ],
  },
  {
    id: "review",
    ...
    dod: [
      { text: "All applicable axes (CODE / DOCS / CONFIG / TEST PR-type classification) pass per /review skill protocol", done: false },
      { text: "All P0 + P1 findings resolved or explicitly deferred with rationale", done: false },
      { text: "Verdict ACCEPT (or DISAGREE_AND_COMMIT with rationale)", done: false },
    ],
  },
  {
    id: "end",
    ...
    depends_on: ["review"],
    dod: [
      { text: "All PLAN parts DONE or explicitly DEFERRED/ABANDONED", done: false },
      { text: "Session-end checklist complete (all [x] in current session note)", done: false },
      { text: "PR created", done: false },
      { text: "npx markdownlint-cli2 --fix \"**/*.md\" clean", done: false },
      { text: "All commits pushed to local branch", done: false },
    ],
  },
];
...
const plan: PlanNote = {
  ...
  objectives: [
    ...
    { id: "O-3", text: "/decompose and /recompose skills operational against ADR notes", done: false },
    { id: "O-4", text: "All 5 adapters (ADR, ANALYSIS, SESSION, PLAN, SPEC subtree) ship with passing round-trip tests", done: false },
    { id: "O-5", text: "/defrag skill operates as periodic curator delegating to /decompose + /recompose", done: false },
    { id: "O-6", text: "/ingest skill ships as Brain-aware variant of memory-ingest with verbatim source preservation", done: false },
    { id: "O-7", text: "Skills installed via symlinks at ~/.claude/skills/<name> → ~/Dev/skills/<name>", done: false },
    { id: "O-8", text: "Zero net-new content drift detected in any test fixture or production note touched by the skills", done: false },
  ],
  parts,
  tasks,
  pending_decisions: [],
