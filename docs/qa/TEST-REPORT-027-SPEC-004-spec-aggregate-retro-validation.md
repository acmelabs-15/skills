---
permalink: qa/test-report-027-spec-004-spec-aggregate-retro-validation-1
---

---
title: TEST-REPORT-027-SPEC-004: Spec-Aggregate Retro-Validation
type: test-report
permalink: qa/test-report-027-spec-004-spec-aggregate-retro-validation
status: DONE
tags:
- test-report
- spec-004
...
# TEST-REPORT-027-SPEC-004: Spec-Aggregate Retro-Validation

## Objective

Aggregate retro-validation verdict for SPEC-004 SPEC Subtree Adapter against its 7 TASKs, 6 REQs, 3 DESIGNs after Wave 2 integration. Roll up per-TASK TEST-REPORT-020 through TEST-REPORT-026 verdicts. Determine whether implementation as-built honors the spec subtree.
...
| TASK | TEST-REPORT | Verdict |
|------|-------------|---------|
| TASK-001 Implement SPEC Subtree Adapter Recursive Base | TEST-REPORT-020 | PARTIAL |
| TASK-002 Implement Frontmatter Map Handler | TEST-REPORT-021 | PARTIAL |
| TASK-003 Implement Filename Rewrite Handler | TEST-REPORT-022 | FAIL |
| TASK-004 Implement Per-File Hash Validation Orchestration | TEST-REPORT-023 | PARTIAL |
| TASK-005 Implement specSubtreeManifestSchema Zod Validator | TEST-REPORT-024 | FAIL |
| TASK-006 SPEC Subtree Test Fixtures | TEST-REPORT-025 | FAIL |
| TASK-007 SPEC Adapter Round-Trip Property Test | TEST-REPORT-026 | PARTIAL |
...
1. **TASK-008-SPEC-004: Add Adapters Barrel and Align sourceType to spec** — addresses barrel + naming drift from TEST-REPORT-020
2. **TASK-009-SPEC-004: Implement Filename Rewrite Unit Tests and Path Containment** — addresses zero-test coverage + missing pre-flight from TEST-REPORT-022
3. **TASK-010-SPEC-004: Add DESIGN Fixture and Composition Plan YAML** — addresses missing DESIGN child + composition YAML from TEST-REPORT-025
4. **TASK-011-SPEC-004: Align Schema Shape to ADR-002 D-5 and REQ-005 AC** — addresses ADR-002 D-5 divergence, empty-children AC, destination path containment from TEST-REPORT-024
5. **TASK-012-SPEC-004: Align Adapter Orchestration to DESIGN-001 and DESIGN-003** — addresses processSubtree / SubtreeOrchestrator / ClusterRollback drift from TEST-REPORT-020 + TEST-REPORT-023
...
- depends_on [[TEST-REPORT-020-SPEC-004: Implement SPEC Subtree Adapter Recursive Base]]
- depends_on [[TEST-REPORT-021-SPEC-004: Implement Frontmatter Map Handler]]
- depends_on [[TEST-REPORT-022-SPEC-004: Implement Filename Rewrite Handler]]
- depends_on [[TEST-REPORT-023-SPEC-004: Implement Per-File Hash Validation Orchestration]]
- depends_on [[TEST-REPORT-024-SPEC-004: Implement specSubtreeManifestSchema Zod Validator]]
- depends_on [[TEST-REPORT-025-SPEC-004: SPEC Subtree Test Fixtures]]
- depends_on [[TEST-REPORT-026-SPEC-004: SPEC Adapter Round-Trip Property Test]]
