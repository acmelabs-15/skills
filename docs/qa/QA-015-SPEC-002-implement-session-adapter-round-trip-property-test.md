---
title: 'QA-015-SPEC-002: Implement SESSION Adapter Round-Trip Property Test'
type: qa
permalink: qa/qa-015-spec-002-implement-session-adapter-round-trip-property-test
status: DONE
tags:
- qa
- spec-002
...
# QA-015-SPEC-002: Implement SESSION Adapter Round-Trip Property Test
...
| DoD 5 — Assertion: decompose output includes cross_source_updates with correct target_note, part_id, field_name, new_value | DoD | [FAIL] | Test asserts target_source_type (literal "plan") not target_note; the schema has no part_id, field_name, or new_value fields — schema shape differs from TASK prescription (see QA-012 for full divergence) |
