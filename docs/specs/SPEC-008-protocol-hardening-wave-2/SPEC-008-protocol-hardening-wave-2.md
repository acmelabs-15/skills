...
Wave 2 of the protocol-hardening initiative. Closes the convergent finding from the 5-audit synthesis ([[ANALYSIS-004: Protocol Hardening Wave 2 Audit Synthesis]]): the rigid per-TASK build+QA protocol existed as PROSE, not RUNTIME ENFORCEMENT. Implements [[ADR-005: Protocol Hardening Wave 2 Architecture]] across 5 tracks — library coverage, per-skill gate scripts, adversarial test harness, drift cleanup, and the plugin-hook enforcement layer. The implementation shipped (47/47 TASKs, suite 1252/0); the validator-parse-conformance + script-wiring + hooks-go-live that make the mechanism live runtime-active are scoped to a follow-on wave (bridge: [[RETRO-004: PLAN-001 Skills Ecosystem Retrospective]]).
...
- [x] [[TASK-011-SPEC-008: Implement validate-task-done Script]]
- [x] [[TASK-012-SPEC-008: Implement transition-impl-item Script]]
- [x] [[TASK-013-SPEC-008: Implement transition-qa-item Script]]
- [x] [[TASK-014-SPEC-008: Implement validate-spec-done and run-pre-flight Scripts]]
- [x] [[TASK-015-SPEC-008: Implement spec-Skill Schema Validator Scripts]]
- [x] [[TASK-016-SPEC-008: Implement lock-decision-mutation Script]]
- [x] [[TASK-017-SPEC-008: Implement render-plan-note and set-part-done Scripts]]
- [x] [[TASK-018-SPEC-008: Implement build-Skill Dispatch-Brief Generators]]
- [x] [[TASK-019-SPEC-008: Implement decisions-Skill Dispatch-Brief Generators]]
- [x] [[TASK-020-SPEC-008: Implement research-Skill and review-Skill Dispatch-Brief Generators]]
...
- [x] [[TASK-041-SPEC-008: Implement pre-write-brain-note Handler Layer 1]]
- [x] [[TASK-042-SPEC-008: Implement pre-write-brain-note-mcp Handler Layer 2]]
