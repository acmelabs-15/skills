...
- [ ] GIVEN SESSION-2026-05-21_01 with duplicate Event 36/37/38 entries (killed-agent re-entry) WHEN TASK-034 runs THEN duplicates are de-duplicated by either renumbering subsequent events or collapsing to single canonical entries per content-equivalence audit
