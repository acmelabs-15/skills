...
- `shared/composition/tests/fixtures/{analysis-sample.md,session-sample.md}` (move if nested-path chosen)
- `shared/composition/tests/{analysis-round-trip,session-round-trip}.test.ts` (modify if YAML loader added)
