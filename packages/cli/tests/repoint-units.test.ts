...
import { parseSectionFragment, sectionAnchored } from "@acmelabs/core/core/repoint-anchors";
import {
  type AddressedEdit,
  applyEdits,
  invertEdits,
  ...
  overlappingEdits,
  verifyAddress,
} from "@acmelabs/core/core/repoint-edits";
import { resolveReplacement } from "@acmelabs/core/core/repoint-resolve";
import {
