...
import {
  ...
  searchExhaustive,
  searchReferences,
} from "@acmelabs/core/core/brain-cli";
import { discoverCandidates, planQueries } from "@acmelabs/core/core/reference-funnel";
import { buildImpactManifest } from "@acmelabs/core/core/reference-scan";
import type { ResolvedTarget } from "@acmelabs/core/schemas/reference-manifest";
